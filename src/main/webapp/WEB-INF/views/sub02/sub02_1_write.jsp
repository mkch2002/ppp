					...
					<div>
						<div class="table"><!--테이블-->
							<table class="tb03 tb_sty02">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<textarea rows="20"  placeholder="개발자님 파일 에디터 넣어주세요 에디터에서 글씨색은 화면 흰색만 가능하게!!" id="sContent"></textarea>
										</td>
									</tr>
									<!--<tr>
										<th scope="col">File</th>
										<td class="color_red">개발자님 첨부파일 에디터 넣어주세요.</td>
									</tr>-->
								</tbody>
							</table>
							...
							<div class="tac btn_same"><!--버튼-->
								<a href="#none" class="btn_sub02" onclick="fnVocValidation()">Save</a>
								<a href="${pageContext.request.contextPath}/sub02/sub02_1.do" class="btn_border">List</a>
							</div>
						</div><!--table-->
					</div>
				<!--오른쪽 게시판 영역 End-->	
	...
	<!-- footer End-->
		...
		function fnVocWrite(){
				...
				var sTitle=document.getElementById("sTitle").value;
		   		...
		   		$.ajax(
		           {
		               url : '${pageContext.request.contextPath}/sub02/writeVoc.do',
