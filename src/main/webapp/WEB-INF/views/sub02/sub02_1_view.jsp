...
<body>
				...
				<!--오른쪽 게시판 영역--> 
					<div><!--190213 class삭제-->
						...
						<div class="tac btn_same mrt50"><!--버튼-->
							<a href="${pageContext.request.contextPath}/sub02/sub02_1_edit.do?sSeq=<%=sSeq%>&sPseq=<%=sPseq%>" class="btn_sub02">Modify</a>
							<a href="#none" class="btn_gray" onclick="fnVocDelete()">Delete</a>
	...
	<!-- footer End-->
		                 ...
		                 success : function(response){
		                     ...
		                     for (var i=0;i<objData.result.length;i++){
		                    	 ...
		                    	 if(objData.result[i].STEP > 0){                             	
		                      		str += "<span style='padding-left:"+(objData.result[i].STEP*18)+"px'><img src='${pageContext.request.contextPath}/resources/images/common/icon_re_reply.png' alt=''><a href='sub02_1_view.jsp?sSeq="+objData.result[i].SEQ+"&sPseq="+objData.result[i].PSEQ+"'>"+objData.result[i].TITLE+"</a></span>";
		                     	 	
		                     	 }else {
		                     		 
		                     		str +="<span><a href='sub02_1_view.jsp?sSeq="+objData.result[i].SEQ+"&sPseq="+objData.result[i].PSEQ+"' class='fz16'>"+objData.result[i].TITLE+"</a></span>";
       ...
       function fnVocDelete(){
    	   
           var sSeq = document.getElementById("sSeq").value;   
           
           $.ajax(
                {
                    url : '${pageContext.request.contextPath}/sub02/deleteVoc.do',
                    data : "sSeq="+sSeq,               
                    method : 'post',
                    dataType : 'json',  
                    success : function(response){
