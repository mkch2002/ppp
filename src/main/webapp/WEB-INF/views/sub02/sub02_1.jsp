...
<head>
    ...
    <script>
		...
		function openKO() {/*절차 가이드 팝업창*/
			var win = window.open("sub02_2_popKO.html", "guide_pop", "width=530px, height=602px, scrollbars=no, toolbar=no, top=0px, left=0px, status=no, resizable=no");
		}
	</script>
</head>
<body>
	...
	<!-- container -->
		<div id="container">
					...
					<ul class="path_top">
						...
						<li class="path_1depth01">
							...
							<ul class="path_sub ps01">
								...
								<li><a href="../sub02${pageContext.request.contextPath}/sub02/sub02_1.do">고충처리</a></li>
						...
						<li class="path_1depth02">
							...
							<ul class="path_sub ps02">
								<li><a href="../sub02${pageContext.request.contextPath}/sub02/sub02_1.do">우리들의 VOC</a></li>
			...
			<!--con_wrap(바뀌는 영역)-->
				<div class="con_wrap">
					<div class="banner_troble mrb34"><!--상단 배너 이미지-->
						<p class="troble_txt">
							고충처리 게시판은 정확한 고충처리를 위해 <strong>비공개/ 실명제</strong>로<br>
							운영되며 관련 내용은 협의회 위원에게만 공개됩니다.<br>
							<span>*법률은 [법률상담], 심리는 [심리상담], 성희롱ㆍ언어폭력은 [신고센터]를 이용해주세요.</span>
						</p>
						<a href="#none" class="btn_openKO" onclick="openKO()">절차 가이드</a>
						<!--<a href="#none" class="btn_openEN">Processing Guide</a>-->
					</div>
					<div class="sub02_tb_top">
						<div class="search_area02"><!--검색영역-->
							...
							<a href="#none" onclick="fnVocList()"><img src="${pageContext.request.contextPath}/resources/images/common/btn_sch.png" alt="검색 버튼"></a>
						</div>
						<div class="bd-total fl mrl20 mrt10"><!--totle 카운트-->
							TOTAL<i class="split"></i><b class="color_blue">28</b>
						</div>
						<div class="btn_same fr"><a href="${pageContext.request.contextPath}/sub02/sub02_1_write.do" class="btn_sub02">Write</a></div><!--버튼-->
					</div>
	...
	<!-- footer End-->
        ...
        $.ajax(
            {
                url : '${pageContext.request.contextPath}/sub02/listVoc.do',                
                data : params,  
                method : 'post',
                dataType : 'json',
                success : function(response){
                    ...
                    for (var i=0;i<objData.result.length;i++){
						 ...
						 if(objData.result[i].STEP > 0){
	                   		...
	                   		str += "<span style='padding-left:"+(objData.result[i].STEP*18)+"px'><img src='${pageContext.request.contextPath}/resources/images/common/icon_re_reply.png' alt=''><a href='sub02_1_view.jsp?sSeq="+objData.result[i].SEQ+"&sPseq="+objData.result[i].PSEQ+"' class='fz16' style='margin-left:10px'>"+objData.result[i].TITLE+"</a></span>";
	                   	 	
	                   	 }else {
	                   		 
	                   		str +="<span><a href='${pageContext.request.contextPath}/sub02/sub02_1_view.do?sSeq="+objData.result[i].SEQ+"&sPseq="+objData.result[i].PSEQ+"' class='fz16'>"+objData.result[i].TITLE+"</a></span>";
	  							
	                   	 }
	                    		str +="<span class='icon_new'><img src='${pageContext.request.contextPath}/resources/images/common/icon_new.png' alt='새로 등록된 게시글(NEW아이콘)' width='16' height='16'></span></p></td><td>"+objData.result[i].STATUS+"</td><td>"+objData.result[i].WRITER+"</td><td>"+objData.result[i].REGDATE+"</td></tr>";
	                 }
