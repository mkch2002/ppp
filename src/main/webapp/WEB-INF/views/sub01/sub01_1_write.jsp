...
<head>
    ...
    <!--css style-->
    <link rel="stylesheet" type="text/css" href="/sp04/resources/css/common.css">
    <link rel="stylesheet" type="text/css" href="/sp04/resources/css/sub01.css">
    <!--script-->
    <script type="text/javascript" src="/sp04/resources/js/jquery-3.3.1.min.js"></script>
    <script>
		$(function(){
			$("nav").hover(function(){
	...
	<!-- container -->
		<div id="container">
			...
			<div class="sub_visual sub01_01_bg">
				<h2><img src="/sp04/resources/images/sub01/sub01_01_title.png" ></h2>
			</div>
					...
					<ul class="path_top">
						<li>
							<a href="../main/index.html">
								<i class="icon_home"><img src="/sp04/resources/images/sub01/btn_path_home.png" alt="ë©ì¸ì¼ë¡ ê°ê¸° ë²í¼"></i>
								Home
							</a>
						</li>
					...
					<div>
						<div class="table"><!--íì´ë¸-->
							...
							<div class="tac btn_same"><!--ë²í¼-->
								<a href="#none" class="btn_sub02" onclick="fnNewsValidation()">Save</a>
								<a href="/sp04/sub01/sub01_1.do" class="btn_border">List</a>
							</div>
						</div><!--table-->
					</div>
