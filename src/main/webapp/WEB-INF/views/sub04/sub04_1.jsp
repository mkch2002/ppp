		...
		<div id="container">
			...
			<div class="inner sub_inner">
				<div><!--경로-->
					<ul class="path_top">
						<li>
							<a href="${pageContext.request.contextPath}/main/index.html">
						...
						<li class="path_1depth01">
							...
							<ul class="path_sub ps01">
								<li><a href="${pageContext.request.contextPath}/sub01/sub01_6.html">About 협의회</a></li>
								<li><a href="${pageContext.request.contextPath}/sub01/sub01_2.html">협의회 소식</a></li>
								<li><a href="${pageContext.request.contextPath}/sub02/sub02_1.html">고충처리</a></li>
								<li><a href="${pageContext.request.contextPath}/sub03/sub03_1.html">소통마당</a></li>
							</ul>
						</li>
						<li class="path_1depth02">
							<a href="#a" class="path_on"><span>소통마당</span><i class="caret"></i></a>
							<ul class="path_sub ps02">
								<li><a href="${pageContext.request.contextPath}/sub03/sub03_1.html">삼건협의회가 간다</a></li>
								<li><a href="${pageContext.request.contextPath}/sub03/sub03_2.html">POLL</a></li>
								<li><a href="${pageContext.request.contextPath}/sub04/sub04_1.html">리조트/휴양소/행사</a></li>
								<li><a href="${pageContext.request.contextPath}/sub04/sub04_2.html"><span>통근버스</span></a></li>
							</ul>
						</li>
					</ul>
				</div>
				...
				<div class="con_wrap">
					<div class="sub02_tb_top">
						<div class="search_area02"><!--검색영역-->
							...
							<input type="search" class="input_srh02"  id="sTitle" ><!--검색어 입력-->
							<a href="#none"><img src="${pageContext.request.contextPath}/resources/images/common/btn_sch.png" alt="검색 버튼" onclick="fn_SearchList()"></a>
						</div>
						<div class="bd-total fl mrl20 mrt10"><!--totle 카운트-->
							TOTAL<i class="split"></i><b class="color_blue">28</b>
						</div>
						<div class="btn_same fr"><a href="${pageContext.request.contextPath}/sub04/sub04_1_write.do" class="btn_sub03">Write</a></div><!--버튼-->
					</div>
                ...
                success : function(response){
                    ...
                    for (var i=0;i<objData.result.length;i++){                    	
                    		...
                    		str +="<tr>";
                       		...
                       		str += "<span style='padding-left:"+(objData.result[i].STEP*18)+"px'><img src='${pageContext.request.contextPath}/resources/images/common/icon_re_reply.png' alt=''><a href='${pageContext.request.contextPath}/sub04/sub04_1_view.do?sSeq="+objData.result[i].SEQ+"&sPseq="+objData.result[i].PSEQ+"' class='fz16' style='margin-left:10px'>"+objData.result[i].TITLE+"</a></span>";
                       	 	
                       	 }else {
                       		 
                       		str +="<span><a href='${pageContext.request.contextPath}/sub04/sub04_1_view.do?sSeq="+objData.result[i].SEQ+"&sPseq="+objData.result[i].PSEQ+"' class='fz16'>"+objData.result[i].TITLE+"</a></span>";
      							
                       	 }
                    		
                    		str +="<em>[0]</em><span class='icon_new'><img src='${pageContext.request.contextPath}/resources/images/common/icon_new.png' alt='새로 등록된 게시글(NEW아이콘)' width='16' height='16'></span></p></td>";
                    		str +="<td>"+objData.result[i].WRITER+"</td><td>"+objData.result[i].ETC+"</td><td>"+objData.result[i].CNT+"</td><td>"+objData.result[i].REGDATE+"</td></tr>";
                    }
