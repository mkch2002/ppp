...
<!-- 										<td><span id="sTitle"></span></td> -->
									...
									<tr>
										...
										<td class="choice_name">${fn:replace(content, newLineChar, "<br/>")}</td>
									</tr>
									<tr>
										<th scope="col">Video</th>
										<td class="vidoe">
											<div style="width: 360px; height:240px; background-color:#eee; color:red;">
											영상
											</div>
										</td>
									</tr>
									...
									<tr>
										<td colspan="2">
											<p class="btn_likeORnot">
												<a title="good" href="#none" class="likeORnot btn_like" onClick="fnCouncilGood();">
													<img src="${pageContext.request.contextPath}/resources/images/common/btn_like.png" alt="추천">&nbsp;<span id="sGood"></span>
												</a>
												<a title="bad" href="#none" class="likeORnot btn_dislike" onClick="fnCouncilBad();">
													<img src="${pageContext.request.contextPath}/resources/images/common/btn_bad.png" alt="비추천">&nbsp;<span id="sBad"></span>
												</a>
											</p>
										</td>
									</tr>
						...
						<div class="tac btn_same mrt50"><!--버튼-->
							<a href="${pageContext.request.contextPath}/sub03/sub03_1_edit.do?sSeq=<%=sSeq%>&sPseq=<%=sPseq%>" class="btn_sub02""> Modify</a>
							<a href="#none" class="btn_gray" onclick="fnCouncilDelete();">Delete</a>
							<a title="답변달기" href="../common/sub_reply.html" class="btn_sub01">Reply</a>
							<a title="목록" href="${pageContext.request.contextPath}/sub03/sub03_1.do" class="btn_border">List</a>
						</div>
					...
					<div class="box_right">
						<h5>
							Latest<strong class="color_blue">공지사항</strong>
						</h5>
	...
	<!-- footer End-->
	       ...
	       $.ajax(
	            {
	                ...
	                success : function(response){
	                    ...
	                    document.getElementById("sContent").innerHTML=response.CONTENT.replace(/\n/gi, '<br />');
       ...
       function fnCouncilDelete(){
    	   
           var sSeq = document.getElementById("sSeq").value;   
           
           $.ajax(
                {
                    url : '${pageContext.request.contextPath}/sub03/deleteCouncil.do',
                    data : "sSeq="+sSeq,               
                    method : 'post',
                    dataType : 'json',  
                    success : function(response){
    	  ...
    	  $.ajax(
            {
                ...
                success : function(response){
                    ...
                    for (var i=0;i<objData.result.length;i++){
                     		...
                     		str +="<li><a href='${pageContext.request.contextPath}/sub03/sub03_1_view.do?sSeq="+objData.result[i].seq+"&sPseq="+objData.result[i].pseq+"'>"+objData.result[i].title+"</a><span class='color_blue'>[0]</span><div class='meta'><i class='icon-view'></i>"+objData.result[i].cnt+"<i class='split'></i>"+objData.result[i].regdate+"</div></li>";
                    }
       ...
       function fnRcouncilList(){

    	   var sPseq = document.getElementById("sPseq").value; 
    	   
     	  $.ajax(
             {
                 url : '/demo5/rcouncilList',
                 data :"sPseq="+sPseq , 
                 method : 'post',
                 dataType : 'json',
                 success : function(response){
                     ...
                     for (var i=0;i<objData.result.length;i++){
                    	 ...
                    	 if(objData.result[i].step > 0){                             	
                     		str += "<span style='padding-left:"+(objData.result[i].step*18)+"px'><img src='${pageContext.request.contextPath}/resources/images/common/icon_re_reply.png' alt=''><a href='${pageContext.request.contextPath}/sub03/sub03_1_view.do?sSeq="+objData.result[i].seq+"&sPseq="+objData.result[i].pseq+"'>"+objData.result[i].title+"</a></span>";
  ...
  function fnCouncilGood(){
    	   
           var sSeq = document.getElementById("sSeq").value;
           
           $.ajax(
                {
                    url : '/demo5/councilGood',
                    data : "sSeq="+sSeq,               
                    method : 'post',
                    dataType : 'json',  
                    success : function(response){
 	 ...
 	 function fnCouncilBad(){
	   
	      var sSeq = document.getElementById("sSeq").value;
	      
	      $.ajax(
	           {
	               url : '/demo5/councilBad',
	               data : "sSeq="+sSeq,               
	               method : 'post',
	               dataType : 'json',  
	               success : function(response){
               ...
               success : function(response){
                   ...
                   for (var i=0;i<objData.result.length;i++){
                    	 ...
                    	 if(objData.result[i].step > 0){
                    		...
                    		str += "<img src='${pageContext.request.contextPath}/resources/images/common/icon_re_reply.png' alt=''><span>"+objData.result[i].nickname+"</span>";
                    	 	
                    	 }else {
                    		 
                    		str += "<span>"+objData.result[i].nickname+"</span>";
