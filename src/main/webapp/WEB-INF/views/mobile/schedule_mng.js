...
function CalAddCss(){
		...
		cssHtml += ".calLayout{	border:1px solid #DDDDDD; background-color:#ECEADF;	position:absolute;padding:2px;display:none;z-index:9999; width:750px !important; 	}";			
		...
		cssHtml += ".calDay{background-color: #FBFBFB;border:1px solid #CBC7BD;	width:100px;float:left;font-size:15pt;padding-top:3px;padding-bottom:2px;cursor:pointer;}";
		cssHtml += ".calSunDay{	background-color: #FBFBFB;border:1px solid #CBC7BD;	width:100px;float:left;font-size:15pt;padding-top:3px;padding-bottom:2px;cursor:pointer;color:red;}";
		cssHtml += ".calSatDay{ background-color: #FBFBFB;border:1px solid #CBC7BD;	width:100px;float:left;font-size:15pt;padding-top:3px;padding-bottom:2px;cursor:pointer;	color:blue;}";
		cssHtml += ".calOtherDay{background-color: #FBFBFB;	border:1px solid #CBC7BD;width:100px;float:left;font-size:15pt;padding-top:3px;padding-bottom:2px;cursor:pointer;color:#CBC7BD;}";
		cssHtml += ".dayToday{background-color: #368CFE;border:1px solid #CBC7BD;font-weight:bold;font-weight:bold;width:100px;float:left;font-size:15pt;padding-top:3px;padding-bottom:2px;cursor:pointer;color:white;	}";
		...
		cssHtml += ".calDayTitle{padding-top:2px; width:100px; float:left;	font-size:20pt; height:50px;}";			
...
function makeCal(id,dates,splitKey){				
	...
	for( i = 1; i<=firstDay; i++){
		html += "<div class='calOtherDay' id='"+ id + beforeYearMonText + (beforeMonLastDay-(firstDay-i)) +"'>"+ (beforeMonLastDay-(firstDay-i)) + "<br>일정1</div><div class='calDaySpace'></div>";
		brCount ++;					
	}	
	...
	for (i = 1; i <= lastDateNum; i++) {					
		...
		html += "<div class='"+ dayCss +"' id='"+ id + nowYearMonText + strFormat(i) +"'>" + i + "<br/>일정2</div>";
	...
	var nexyStartDay = 1;
	for( i = lastDay; i<6; i++){
		html += "<div class='calOtherDay' id='" +id + nextYearMonText + strFormat(nexyStartDay) +"'>"+ nexyStartDay++ + " <br/>일정3</div><div class='calDaySpace'></div>";
	}
